...
<div className={styles.container} >
    ...
    <div className={styles.info}>
        ...
        <div className={styles.text}>
         <h3 className={styles.h33} style={{fontSize:'22px',fontWeight:'600',fontFamily:'Poppins' }}>  B.COM,CA,CMA And SET </h3>
         <p style={{fontSize:'16px'}}>    <strong> CA Dhiraj Ostwal </strong>  is an experienced and professional CA
  ...
  <div className={styles.purpose}>
    <div >
    <h2>Vision</h2>
    <p style={{fontSize:'16px'}}>To become the most trusted, efficient and result-oriented companion to empower entrepreneurs, Start-ups and corporates for uninterrupted growth through world-class business strategies.</p>
          
    </div>
    <div >
    <h2>Mision</h2>
    <p style={{fontSize:'16px'}}> To reach out 1000+ businesses to boost their profitability through most sustainable business strategies which will have positive impact on taxes, human resources, finance, resources and overall key factors of organisation</p>
