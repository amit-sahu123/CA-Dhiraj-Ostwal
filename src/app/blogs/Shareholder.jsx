...
const Shareholder = () => {
  ...
  return (
    ...
    <title>Shareholder Agreements Services | Expert Drafting & Advisory by CA Firm</title>
        ...
        />
        <link rel="canonical" href="https://www.cadhirajostwal.com/services/appLiti/shareagree" />
        <meta
          name="keywords"
...
shareholders agreement format india"
    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.body}>
        ...
        <Link href={'/services/appLiti/draft'}>
              <h1>Drafting</h1>
            </Link>
            <Link href={'/services/appLiti/partnerdeed'}>
              <h1>Partnership Deed</h1>
            </Link>
            <Link href={'/services/appLiti/aoa'}>
              <h1>Articles of Association
              </h1>
            </Link>
            <Link href={'/services/appLiti/moa'}>
              <h1>Memorandum of Association</h1>
            </Link>
            <Link href={'/services/appLiti/debenagree'}>
              <h1>Debentures</h1>
            </Link>
            <Link href={'/services/appLiti/hire'}>
              <h1>Hire Purchase Agreements</h1>
            </Link>
            <Link href={'/services/appLiti/lease'}>
              <h1>Understanding Lease Deeds</h1>
            </Link>
            <Link href={'/services/appLiti/contagree'}>
              <h1>Contracts and Agreements</h1>
            </Link>
        </div>
