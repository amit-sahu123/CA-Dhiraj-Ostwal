       ...
       <div className={styles.secondcontainer}>
        ...
        <div className={styles.onlineform }>
          ...
          <PersonIcon color="primary"/>
            <input type="text" className='name'name='name' id='name' placeholder=' Your name*' value={formData.name} onChange={handleChange} />
          </div>
          <div className={`${styles.formgroup} ${styles.p11}`}>
          <AddIcCallIcon color="primary"/>
            <input type="tel" className='phone' name='tel' id='phone' placeholder=' Phone number*' value={formData.tel}  onChange={handleChange}  />
          </div>
          <div className={`${styles.formgroup} ${styles.p11}`}>
          <EmailIcon color="primary"/>
            <input type="email" className='email' name='email' id='email' placeholder=' Email address*' value={formData.email}  onChange={handleChange}    />
          </div>
          <div className={`${styles.formgroup} ${styles.p11} ${styles.p22}`}>
  ...
  <label htmlFor="file" className={styles.customFileLabel}>
    <span className="file-text">
      {formData.file ? formData.file.name : 'Upload your CV *'}
          ...
          {/* <div className={`${styles.formgroup} ${styles.p11} `}>
          <CardTravelIcon color="primary"/>
            <input type="file" id='file' name='file' accept='application/pdf'   onChange={handleChange}  style={{display:'none'}}/>
            <label htmlFor="file"><span className='file-text'>
                    {formData.file ? formData.file.name : 'Upload your CV *'}
                  </span></label>
          </div> */}
          ...
          <div className={`${styles.formgroup} ${styles.marrtop}`}>
            <button type="submit" id='button' name='button' > Send To Us</button>
          </div>
           {formSubmitted && (
